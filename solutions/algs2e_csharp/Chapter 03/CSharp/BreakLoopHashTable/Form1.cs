...
namespace BreakLoopHashTable
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            list1HasLoopTextBox.Text = HasLoopHashTable(sentinel1).ToString();
            ...
            // Indicate whether the list has a loop.
            list2HasLoopTextBox.Text = HasLoopHashTable(sentinel2).ToString();
        ...
        private bool HasLoopHashTable(Cell sentinel)
        {
            // Make a hash set.
