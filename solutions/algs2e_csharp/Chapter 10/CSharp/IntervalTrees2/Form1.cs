...
namespace IntervalTrees2
{
    public partial class Form1 : Form
    {
        ...
        private const int TargetRadius = 25;
        ...
        private void canvasPictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (TestX >= 0)
            {
                e.Graphics.FillRectangle(Brushes.LightGreen,
                    TestX - TargetRadius, 0,
                    2 * TargetRadius, canvasPictureBox.ClientSize.Height);
            }
            ...
            if (TestX >= 0)
            {
                e.Graphics.DrawLine(GreenPen,
                    TestX - TargetRadius, 0, TestX - TargetRadius,
        ...
        private void UseIntervalTree()
        {
            ...
            Root.FindOverlappingIntervals(
                hits, TestX - TargetRadius, TestX + TargetRadius);
        ...
        private void MakeRandom()
        {
            ...
            for (int y = 0; y < canvasPictureBox.ClientSize.Height; y += 4)
            {
                int x = 4;
                while (x < canvasPictureBox.ClientSize.Width)
                {
