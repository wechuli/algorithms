...
namespace TrapezoidRule
{
    public partial class Form1 : Form
    {
        ...
        private void integrateButton_Click(object sender, EventArgs e)
        {
            ...
            // Integrate.
            double estArea = IntegrateTrapezoid(F, xmin, xmax, intervals);
        ...
        private double IntegrateTrapezoid(Func<double, double> function, double xmin, double xmax, int intervals)
        {
            ...
            for (int interval = 0; interval < intervals; interval++)
            {
                ...
                total += dx * (function(x) + function(x + dx)) / 2.0f;
        ...
        private void DrawGraph(Func<double, double> function)
        {
            ...
            using (Graphics gr = Graphics.FromImage(bm))
            {
                ...
                using (Pen thin_pen = new Pen(Color.Red, 0))
                {
                    ...
                    FillTrapezoids(gr, function, xmin, xmax, ymin, ymax, intervals);
                    DrawTrapezoids(gr, function, xmin, xmax, ymin, ymax, intervals);
        ...
        private void DrawTrapezoids(Graphics gr, Func<double, double> function, double xmin, double xmax, double ymin, double ymax, int intervals)
        {
        ...
        private void FillTrapezoids(Graphics gr, Func<double, double> function, double xmin, double xmax, double ymin, double ymax, int intervals)
        {
            float dx = (float)((xmax - xmin) / intervals);
