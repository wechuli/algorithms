...
class TreeNode:
    ...
    def find_lca(self, value1, value2):
        ...
        Call this method only for the root node.
        """
        lca, contains1, contains2 = self.contains_nodes(value1, value2)
        return lca

    def contains_nodes(self, value1, value2):
        """
        Find the LCA for the two nodes.
        Return the LCA and two booleans indicating whether
        this subtree contains each of the two values.
        """
        # See if this node contains either value.
        contains1 = (self.value == value1)
        contains2 = (self.value == value2)
        ...
        for child in self.children:
            # Check this child.
            lca, has1, has2 = child.contains_nodes(value1, value2)
            ...
            assert not (has1 and has2), \
                f"Child subtree {child.value} contains {value1} and {value2} but does not contain the LCA."

            # If we found both values in different
            # children, then this is the LCA.
            if contains1 and contains2:
                return self, True, True
        return None, contains1, contains2
