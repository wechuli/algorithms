...
class App:
    ...
    def __init__(self):
        ...
        # Set up tkinter.
        self.window = tk.Tk()
        self.window.title("complete_self_avoiding_walk")
    ...
    def draw_walk(self):
        """ Draw a new complete self avoiding walk."""
    ...
    def find_walk(self, width, height):
        ...
        # Extend the walk.
        self.extend_walk(width, height, x, y, walk, visited)

        return walk

    def extend_walk(self, width, height, x, y, walk, visited):
        """
        Extend the walk from position [x, y].
        Return true if we find a complete walk.
        """
        # If the list is already long enough, we've found the walk.
        if len(walk) == width * height:
            return True
        ...
        for point in neighbors:
            ...
            if self.extend_walk(width, height, point[0], point[1], walk, visited):
                return True
