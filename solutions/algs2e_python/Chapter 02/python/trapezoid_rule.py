...
def integrate_trapezoid(function, xmin, xmax, intervals):
    ...
    for interval in range(intervals):
        ...
        total += dx * (function(x) + function(x + dx)) / 2
...
class App:
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("trapezoid_rule")
    ...
    def integrate(self):
        ...
        # Integrate.
        est_area = integrate_trapezoid(self.f, xmin, xmax, intervals)
    ...
    def draw_graph(self):
        ...
        self.draw_trapezoids(self.f, xmin, xmax, intervals, "lightblue", "blue")
    ...
    def draw_trapezoids(self, function, xmin, xmax, intervals, fill, outline):
        ...
        for interval in range(intervals):
            ...
            y0 = function(x)
            y1 = function(x + dx)
            points = [ x, 0, x, y0, x + dx, y1, x + dx, 0 ]
            self.drawing_canvas.wdraw_polygon(points, fill, outline)
