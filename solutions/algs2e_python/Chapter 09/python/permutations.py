...
def permute_k_of_n_with_duplicates(index, selections, items, results):
    ...
    if index == len(selections):
        ...
        for i in range(len(items)):
            ...
            permute_k_of_n_with_duplicates(index + 1, selections, items, results)

def permute_k_of_n_without_duplicates(index, selections, items, results):
    ...
    if index == len(selections):
        ...
        for i in range(len(items)):
            ...
            if not used:
                ...
                # Recursively make the other assignments.
                permute_k_of_n_without_duplicates(index + 1, selections, items, results)
...
class App:
    ...
    def go(self):
        ...
        results = []
        permute_k_of_n_with_duplicates(0, selections, items, results)
        ...
        selections = [0 for i in range(k)]
        results2 = []
        permute_k_of_n_without_duplicates(0, selections, items, results2)
