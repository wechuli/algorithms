...
class App:
    ...
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("eight_queens")
    ...
    def solve(self):
        ...
        success, num_attempts = self.eight_queens(spot_taken, 0)
        stop_time = time.time()
    ...
    def eight_queens(self, spot_taken, num_queens_positioned):
        """
        ...
        for row in range(self.num_rows):
            for col in range(self.num_cols):
                if not spot_taken[row][col]:
                    ...
                    success, new_num_attempts = self.eight_queens(spot_taken, num_queens_positioned + 1)
