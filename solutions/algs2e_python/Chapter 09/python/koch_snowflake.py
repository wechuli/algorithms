...
def draw_koch(canvas, color, depth, pt1, angle, length):
    if depth == 0:
        pt2 = (
        ...
        draw_koch(canvas, color, depth - 1, pt1, angle, new_length)
        draw_koch(canvas, color, depth - 1, pt2, theta1, new_length)
        draw_koch(canvas, color, depth - 1, pt3, theta2, new_length)
        draw_koch(canvas, color, depth - 1, pt4, angle, new_length)
...
class App:
    ...
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("koch_snowflake")
    ...
    def draw(self):
        ...
        draw_koch(self.canvas, color, depth, pt1, 0, triangle_width)
        draw_koch(self.canvas, color, depth, pt2, angle120, triangle_width)
        draw_koch(self.canvas, color, depth, pt3, angle240, triangle_width)
