...
class Boid:
    ...
    def move(self, boids, target, delta_time, separation_wgt, \
        alignment_wgt, cohesion_wgt, target_wgt):
        """ Move the Boid."""
        num_neighbors = 0
...
class App:
    ...
    def __init__(self):
        ...
        self.window = tk.Tk()
        self.window.title("boids_classical")
    ...
    def draw_frame(self):
        ...
        for boid in self.boids:
            boid.move(self.boids, target, delta_time, \
                self.separation_wgt, self.alignment_wgt, \
                self.cohesion_wgt, self.target_wgt)
