...
cc = CreditCard('Paul Wechuli', 'Equity Bank', '1235 5258 569', 500000)


# As a general rule, we will treat all data members as nonpublic.This allows us to better enforce a consisten state for all instances. In the context of data structures, encapsulatin the internal representation allows us greater flexibility to redesign the way a class works, perhaps to improve the efficiency of the structure
